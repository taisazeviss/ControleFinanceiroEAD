<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-edit fa-3x"></i> Categoria<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-edit fa-3x"></i> Conta<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-edit fa-3x"></i> Movimento<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="index.php"><i class="fa fa-power-off fa-3x"></i> Sair</a>
            </li>
        </ul>
    </div>
</nav>